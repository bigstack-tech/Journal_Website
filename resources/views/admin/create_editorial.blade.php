        ...
        <div class="col-12">
          <div class="card mt-4">
            ...
            <div class="card-body px-5">
                <div>
                    <form action="{{ route('confirm.editorials') }}" method="POST">
                       @csrf
                        <div>
                       ...
                       <span style="color: red">@error('phone'){{ $message }} @enderror </span>
                        <div>
                            <label for="useremail">Institute:</label>
                            <input type="text" name="institute" id="" required>
                       </div>
                       <div>
                       ...
                       <div>
                            <input type="submit" value="Add New Editorial" style="background-color: lightgreen; padding:10px">
                       </div>
                    </form>
                </div>
            </div>
