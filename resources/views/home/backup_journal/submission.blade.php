...
@section('content')
<br><br>
<h1 style="text-align: center">Submit Journal</h1>
<br>
<p style="color: green; text-align: center">{{ session('mssg') }}</p>
<br>
{{-- <h3 style="background-color: lightgreen; padding:10px;">{{ $message }}</h3> --}}
<br><br>
<section class="formSec">
    <form action="{{ route('upload.post') }}" method="POST" enctype="multipart/form-data">
        ...
        <div>
            ...
            <br>
            <textarea name="abstract" id="abstract" cols="30" rows="10" placeholder="Abstract" required></textarea>
        </div>
        <span style="color: red">@error('abstract'){{ $message }} @enderror </span>
        <br>
        <br>
        ...
        <div>
            ...
            <br>
            <input type="text" name="institute" id="institute" placeholder="Institute/Organization" required>
        </div>
        <span style="color: red">@error('institute'){{ $message }} @enderror </span>
        <div>
