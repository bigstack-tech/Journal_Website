...
<html lang="en">
  ...
  <head>
    ...
    <meta name="keywords" content="World, Environmental, Journal, unical, University, Sciences, Paper" />
    <meta name="description" content="World Environmental Journal, journal website" />
    @foreach($Journal_submission as $post)
        <meta name="citation_title" content="{{ $post->title }}" />
        <meta name="citation_author" content="{{ $post->author_name }}" />
        <meta name="citation_journal_title" content="World Environmental Journal" />
        <meta name="citation_volume" content="{{ $post->year }}" />
        <meta name="citation_issue" content="{{ $post->citation_issue }}" />
        <meta name="citation_firstpage" content="{{ $post->first }}" />
        <meta name="citation_lastpage" content="{{ $post->last }}" />
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <a href="{{route('home')}}"><img src="{{ asset('assets/images/mjrdpLogo.png')}}" alt="" style="max-width:15%" class="img-fluid"></a>
      ...
      <nav id="navbar" class="navbar">
          <ul>
            ...
            <ul>
              ...
              <li><a href="{{ route('journal.submission') }}"><span>Submit a journal</span></a>
              </li>
            </ul>
          </li>
